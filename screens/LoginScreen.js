      ...
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ flexGrow: 1, paddingTop: 36, paddingHorizontal: 16, paddingBottom: 16 }} style={{ flex: 1, backgroundColor: '#ffffff' }}>
        ...
        <View>
          ...
          <View style={[styles.card, { marginTop: 40 }]}>
            <Text style={[styles.label, { color: '#558B97', fontSize: 18 }]}>Log In</Text>
            <TextInput
              value={email}
            ...
            <TextInput
              ...
              returnKeyType="done"
            />
            {error ? <Text style={[styles.errorText, {alignSelf: "center"}]}>{error}</Text> : null}
            <Text style={[styles.label, { color: '#9aa0a6', alignSelf: 'center', fontSize: 16 }]}>OR</Text>
            <TouchableOpacity onPress={onSignUpPress} accessibilityLabel="Go to Sign Up">
              <Text style={[styles.label, { color: '#08a6c2', alignSelf: 'center', fontSize: 18 }]}>Sign Up</Text>
            </TouchableOpacity>
          </View>
        </View>

        <TouchableOpacity style={styles.fab} accessibilityLabel="Continue" onPress={handleLogin}>
